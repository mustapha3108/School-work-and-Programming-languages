...
\begin{document}
	...
	%	\includegraphics[width=4cm]{images.png}\par
		...
		{\Large  \textbf{Prof: Mme.Moussaoui} \par}
		\vspace{2cm}
		...
		\begin{flushleft}
			...
			\vspace{0.25cm}
			{\large - \textbf{Ben chaban Razika :} partie Code } \\
			\vspace{0.25cm}
	...
	\textbf{complexité spacial: theoriquement O(1) mais la majorité des implementations necessite des vecteur temporaires donc pratiquement O(n x k) $\rightarrow $ SEULEMENT SI ON NÉGLIGE LA MEMOIRE NÉCESSAIRE POUR LES APPELLES RECURSIVES LARGEMENT DEPENDANTE SUR LE LANGUAGE DE PROGRAMATION} \\
