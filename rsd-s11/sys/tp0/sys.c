...
/*
-the father has to end before children...duh
-if child ends first then the father process changes and not all children may execute
-getpid(), getppid(), get process id and get parent process id
*/